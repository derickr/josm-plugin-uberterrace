...
public class HouseNumberInputHandler extends JosmAction implements ActionListener, FocusListener, ItemListener {
    ...
    public boolean doFancyOutline() {
        return dialog.fancyOutlineCheckBox.isSelected();
    }
    ...
    public void saveValues() {
        ...
        Config.getPref().putBoolean(HouseNumberInputDialog.FANCY_OUTLINE, doFancyOutline());
        ...
        newNr += stepSize();
        Config.getPref().put(HouseNumberInputDialog.NEXT_HOUSENR, String.valueOf(newNr));
